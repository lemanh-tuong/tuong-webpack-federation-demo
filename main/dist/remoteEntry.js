...
"use strict";
eval("var moduleMap = {\n\t\"./AppContent\": () => {\n\t\treturn Promise.all([__webpack_require__.e(\"webpack_sharing_consume_default_react_react\"), __webpack_require__.e(\"src_AppContent_jsx\")]).then(() => (() => ((__webpack_require__(/*! ./src/AppContent.jsx */ \"./src/AppContent.jsx\")))));\n\t}\n};\nvar get = (module, getScope) => {\n\t__webpack_require__.R = getScope;\n\tgetScope = (\n\t\t__webpack_require__.o(moduleMap, module)\n\t\t\t? moduleMap[module]()\n\t\t\t: Promise.resolve().then(() => {\n\t\t\t\tthrow new Error('Module \"' + module + '\" does not exist in container.');\n\t\t\t})\n\t);\n\t__webpack_require__.R = undefined;\n\treturn getScope;\n};\nvar init = (shareScope, initScope) => {\n\tif (!__webpack_require__.S) return;\n\tvar name = \"default\"\n\tvar oldScope = __webpack_require__.S[name];\n\tif(oldScope && oldScope !== shareScope) throw new Error(\"Container initialization failed as it has already been initialized with a different share scope\");\n\t__webpack_require__.S[name] = shareScope;\n\treturn __webpack_require__.I(name, initScope);\n};\n\n// This exports getters to disallow modifications\n__webpack_require__.d(exports, {\n\tget: () => (get),\n\tinit: () => (init)\n});\n\n//# sourceURL=webpack://main/container_entry?");

/***/ }),

/***/ "webpack/container/reference/main":
/*!************************************************************!*\
  !*** external "main@http://localhost:3001/remoteEntry.js" ***!
  \************************************************************/
...
module.exports = new Promise((resolve, reject) => {
	if(typeof main !== "undefined") return resolve();
...
/******/ 		var chunkMapping = {
/******/ 			"src_App_jsx": [
/******/ 				"webpack/container/remote/main/AppContent"
/******/ 			]
/******/ 		};
...
/******/ 					initExternal("webpack/container/reference/main");
/******/ 				}
/******/ 				break;
/******/ 			}
